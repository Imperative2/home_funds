...
--
-- Host: 127.0.0.1
-- Czas generowania: 11 Wrz 2020, 16:27
...
(6, 11, 'adas', 'ala ma kota', NULL),
(7, 11, 'Karol', 'asdfasdf', NULL),
(8, 11, 'kuir', 'kuir', NULL),
(9, 11, 'Karol', '', NULL),
(10, 11, 'aaa', 'asdf', NULL),
(11, 18, 'pawGaw homse', 'Paw gaw is a big dick', NULL);
...
(24, 9, 'Milk'),
(25, 10, 'Srajtaśma'),
(26, 10, 'Ręczniki papierowe'),
(27, 10, 'Płyn do naczyń'),
(28, 10, 'Worki na śmieci'),
(29, 10, 'Olejek'),
(30, 10, 'Mydełko'),
(31, 10, 'Zmywaki'),
(32, 10, 'Kibel'),
...
(23, '/photo/download/23.png', '2020-09-10');
...
(11, 'Kaśluch', 'Marol', 'imperativeGT', 'mail@mail.com', '$2a$10$wUB1sos.wYKhnTkiwyYtG.BJS6CP9RRWjQ0UvH/GBU6FB5UmO6XJG', 'new description', '#fcba03', 14),
...
(17, 'Karol', 'Maśluch', 'imperative5', 'nie336@gmail.com', '$2a$10$9xYshJUzpt45xaFWtwKfk.zx9QPw3FCvdzcl5zFe94/UnQgKY3/1K', '', '#9c27b0', NULL),
(18, 'Paweł', 'Gaweł', 'pawgaw', 'pawgaw@g.com', '$2a$10$1pc2zvNL1c0BazvQOAe2zOdbPLo9bYjsrGhCtRZDQVvHIFi7.xali', 'Paw gaw is a true master', '#9c27b0', 23);
...
(1, 1, 1, '2020-09-03', 'onun', ''),
(2, 11, 11, '2020-09-03', 'alalalalal', NULL),
(3, 11, 1, '2020-09-03', 'alalalalal', NULL),
(4, 12, 11, '2020-09-09', 'asdfasdf', NULL),
(5, 12, 11, '2020-09-09', 'asdfasdf', NULL),
(6, 12, 11, '2020-09-09', 'asdfasdf', NULL),
(7, 12, 11, '2020-09-09', 'asdfasdf', NULL),
(8, 12, 11, '2020-09-09', 'asdfasdf', NULL),
(9, 12, 11, '2020-09-09', 'mleko', NULL),
(10, 12, 11, '2020-09-09', 'ttt', NULL),
(11, 13, 11, '2020-09-09', 'tt', NULL),
(12, 13, 11, '2020-09-09', 'sdfsf', NULL),
(13, 13, 11, '2020-09-09', 'asdfsadf', NULL),
(14, 13, 11, '2020-09-09', 't', NULL),
(15, 11, 11, '2020-09-09', 'sdfsdf', NULL),
(16, 11, 11, '2020-09-09', '', NULL),
(17, 11, 11, '2020-09-09', 'sdf', NULL),
(18, 11, 11, '2020-09-09', '', NULL),
(19, 11, 11, '2020-09-09', '', NULL),
(20, 11, 11, '2020-09-09', 'sdf', NULL),
(21, 13, 11, '2020-09-09', '', NULL),
(22, 13, 11, '2020-09-09', 'kkk', NULL),
(23, 13, 11, '2020-09-09', 'asdf', NULL),
(24, 22, 11, '2020-09-09', '', NULL),
(25, 33, 11, '2020-09-09', 'wrwer', NULL),
(26, 33, 11, '2020-09-09', '', NULL),
(27, 33, 11, '2020-09-09', '', NULL),
(28, 25, 11, '2020-09-10', '', NULL),
(29, 35, 18, '2020-09-10', 'asdf', NULL),
(30, 34, 13, '2020-09-10', '', NULL),
(31, 35, 11, '2020-09-10', '', NULL);
...
--
ALTER TABLE `household`
  MODIFY `household_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
