...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Sie 2020, 16:19
...
CREATE TABLE `user` (
  ...
  `avatar` text COLLATE utf8mb4_polish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
...
(2, 'Karol', 'Masluch', 'imperative3', 'mails', 'haha', '', '#fcba03', NULL),
...
(11, 'Kaśluch', 'Marol', 'imperativeGT', 'mail@mail.com', '$2a$10$cACD0bmzTKr82Jpa0Pto/uXN78SGHWcW1OvutjuvaKwO5H6qqVr4i', '', '#fcba03', NULL),
(12, 'Kaśluch', 'Marol', 'imperativeGTS', 'mail2@mail.com', '$2a$10$c71DxXSGWMuzvJux0/YL9OTcrn6XXqVdgu21S3U2H/4S8IN/ux.SW', '', '#fcba03', NULL),
(13, 'Karol', 'Maśluch', 'doggerstand', 'nie335@gmail.com', '$2a$10$haCrF.nVE68guatWllLDFukjPtMzu5ASyfpYotK1nGbbq0sa8GkV6', '', '#cddc39', NULL);
